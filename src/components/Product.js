    ...
    <div>
      ...
      >
        ...
        <div
         ...
         p-2 flex flex-col gap-y-2 opacity-0 group-hover:opacity-100 
        ...
        >
          ...
          <button onClick={() => addToCart(id, product)}>
            <div
             ...
             text-white w-12 h-12 drop-shadow-xl"
            >
          ...
          <Link
            to={`/product/${id}`}
            className="text-primary bg-white flex justify-center items-center
             text-black w-12 h-12 drop-shadow-xl"
          >
            <BsEyeFill />
          </Link>
        </div>
      ...
      <div>
        <div className=" text-sm capitalize text-gray-600 mb-1">{category}</div>
        <Link to={`/product/${id}`}>
